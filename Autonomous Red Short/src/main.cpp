...
int main() {
  ...
  UpperIntake.rotateFor(directionType::rev, 85, rotationUnits::deg, 75, velocityUnits::pct, false);
  LowerIntake.rotateFor(directionType::rev, 85, rotationUnits::deg, 75, velocityUnits::pct, true);
